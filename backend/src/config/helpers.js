...
let conn = new Mysqli({
    Host: dbconfig.HOST || 'localhost', // IP/domain name 
    port: dbconfig.port || 3306, // port, default 3306 
    user: dbconfig.USER || 'root', // username 
    passwd: dbconfig.PASSWORD || '', // password 
    db: dbconfig.DB || 'mega_shop'
});
